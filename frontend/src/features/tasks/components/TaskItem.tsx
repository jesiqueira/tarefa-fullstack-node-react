      ...
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-start justify-between mb-2 lg:hidden">
            ...
            <button onClick={() => onDelete(task.id)} className="text-gray-400 hover:text-red-600 transition-colors p-1">
          ...
          {/* Título e Descrição */}
          <h3 className="text-lg font-semibold text-gray-900 mb-2 line-clamp-2">{task.titulo}</h3>
          <p className="text-gray-600 text-sm mb-3 line-clamp-3">{task.descricao}</p>
